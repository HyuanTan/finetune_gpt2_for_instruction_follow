...
def main():
    ...
    train_portion = int(len(data) * 0.80)  # 85% for training
    test_portion = int(len(data) * 0.15)    # 10% for testing
    ...
    # model_name = "gpt2-medium355M-2-alpaca_data_52k.json-best_sft.pth"
